...
func runWithContext(ctx context.Context, args []string) error {
	...
	flags.StringVar(&baseURLArg, "base-url", "", "base URL (default: http://localhost:11434/v1; env: OPENAI_BASE_URL)")
	flags.StringVar(&baseURLArg, "u", "", "base URL (shorthand)")
	flags.StringVar(&modelArg, "model", "", "model name (default: llama3; env: OPENAI_MODEL)")
	...
	flags.BoolVar(&versionArg, "version", false, "print build version information")
	...
	flags.Usage = func() {
		...
		fmt.Fprintln(os.Stderr, "  --base-url, -u <url>              Base URL (default: http://localhost:11434/v1; env: OPENAI_BASE_URL)")
		fmt.Fprintln(os.Stderr, "  --api-key <key>                   API key (optional, env: OPENAI_API_KEY)")
		fmt.Fprintln(os.Stderr, "  --model, -m <name>                Model name (default: llama3; env: OPENAI_MODEL)")
